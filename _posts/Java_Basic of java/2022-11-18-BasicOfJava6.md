...
- 1990년대 말 2000년대 초 인터넷이 활성화 될 때 자바 언어를 기본으로 한 웹 프로그래밍 JSP, servlet이 유행하면서 유명해졌다.
...
- JRE java 실행자의 경우는 JRE만 있으면 된다. ( 자바 프로그램이 실행될 수 있는 환경을 만들어준다. )
