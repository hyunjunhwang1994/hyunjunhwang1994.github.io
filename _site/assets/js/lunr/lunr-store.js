var store = [{
        ...
        "excerpt":"지금까지 인텔리 제이 커뮤니티 버전으로 잘 사용해 왔습니다만.. 커뮤니티 버전으로 스프링 공부를 하던 도중, 빈번하게 발생하는 스프링 프로젝트 생성, SQL 관련 작업 등 불편한 점이 많더라고요, 그래서 너무 불편해서 팀원들이랑 소통하던 중, 항해에서 4개월치 인텔리 제이 얼티메이트를 제공해 준다 하더라고요..??? 그래서 해당 노션 문서를 보고 4개월 얼티메이트 코드를 찾았고, 사용해서...","categories": ["항해99"],
        "tags": ["항해99","TIL"],
