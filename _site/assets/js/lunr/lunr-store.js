var store = [{
        ...
        "title": "항해99 TIL 10일 차 언어 기본기 주차(자바)",
        ...
        "title": "항해99 TIL 11일 차 언어 기본기 주차(자바)",
        ...
        "title": "항해99 TIL 12일 차 프로그래밍 주차",
        "excerpt":"프로그래밍 주차 시작! 오늘 아침엔 프로그래밍 주차 발제가 있었다. 2일간 자바 공부를 했던 팀과는 언어 스터디 팀으로 되어 항해99가 끝날 때까지 매주 금요일 9시에 보기로 하였고, 오늘부터 7일 동안은 알고리즘(코딩 테스트) 위주로 공부하는 시간이다. 이번 7일의 목표는 자바 기초를 다지고 구현력을 키우는 것이 목표이다! 그래서 프로그래머스 알고리즘 풀이 위주로 공부하고...","categories": ["항해99"],
        "tags": ["항해99","TIL"],
        "url": "/%ED%95%AD%ED%95%B499/TIL11/",
        "teaser": null
      },{
        "title": "항해99 WIL 2주 차 회고",
        "excerpt":"항해99를 시작한 지 2주가 되어간다. 이번 주는 첫 풀스택 프로젝트가 끝나고 2일간의 언어 기본기(자바) 주 차가 끝나고 프로그래밍 기초(알고리즘) 주 차가 시작되고, 현재 진행 중이다. 사실 코딩 테스트는 많이 안 해봐서 익숙하지 않아 초반에 조금 어려웠지만, 하다 보니 나오는 문제가 비슷비슷한 것 같아 많이 풀어보는 게 답인 것 같다. 이번...","categories": ["항해99"],
        "tags": ["항해99","WIL"],
