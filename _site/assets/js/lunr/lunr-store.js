var store = [{
        ...
        "excerpt":"벌써 항해99를 시작한지 28일이 되어간다.   옛날에 다른 학원에서 공부했었을때는  자바1달.. 파이썬1달.. 이런식으로 배운 것 같은데   시작한지 28일이 됫음에도, 그때와 비교하면 많은 것들을 배운 것 같다.   DI, IoC, Bean   공부한 내용과, TIL(WIL)을 같이 올리려다보니 각 포스팅에서 쓴 내용이 달라지기도하고 힘들기도하여서 아래의 링크에   이번주 WIL키워드에 관한 내용을 정리했다.   ","categories": ["항해99"],
        "tags": ["항해99","WIL"],
